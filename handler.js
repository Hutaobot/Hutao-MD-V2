        ...
        for (let name in global.plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                    this.reply(m.chat, `[❗] Limit kamu habis, beberapa command tidak dapat di akses, harap tunggu besok pukul 05.00 WIB atau kamu bisa melakukan upgrade premium untuk mendapatkan unlimited limit`, m)
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*Hanya Developer* • Command ini hanya untuk developer bot',
        owner: '*Hanya Owner* • Command ini hanya untuk owner bot',
        mods: '*Hanya Moderator* • Command ini hanya untuk moderator bot',
        premium: '*Hanya Premium* • Command ini hanya untuk user premium',
        group: '*Hanya Group Chat* • Command ini hanya bisa dipakai didalam group',
        private: '*Hanya Private Chat* • Command ini hanya bisa dipakai diprivate chat',
        admin: '*Hanya Admin* • Command ini hanya untuk admin group',
        botAdmin: '*Hanya Bot Admin* • Command ini hanya bisa digunakan ketika bot menjadi admin',
        unreg: '*Anda Belum Terdaftar* • ᴋᴇᴛɪᴋ  .daftar ᴜɴᴛᴜᴋ ʙɪsᴀ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ғɪᴛᴜʀ ɪɴɪ', 
